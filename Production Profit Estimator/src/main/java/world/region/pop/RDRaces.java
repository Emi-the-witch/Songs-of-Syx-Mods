...
public class RDRaces {
	...
	public RDRaces(RDInit init){
		...
		workforce = BOOSTING.push("WORKFORCE", 0, Dic.¤¤Workforce, ¤¤workforceD, UI.icons().s.pickaxe, BoostableCat.WORLD);
		...
		population = pop;
		GVALUES.REGION.pushI("POPULATION", Dic.¤¤Population, pop);
		GVALUES.REGION.pushI("POPULATION_KINGDOM", Dic.¤¤Population + ": " + Dic.¤¤Realm, new INT_O<Region>() {
